...
lbl_title = Label(win, text="Banking Automation",bg="powder blue", font=('Calibri', 55, 'bold', 'underline'))
lbl_title.pack()
lbl_title.place(relx=.3,rely=.02)
img=Image.open("logo.png").resize((140,140))
imgtk=ImageTk.PhotoImage(img,master=win)
lbl_logo=Label(win,image=imgtk,bg= "powder blue")
lbl_logo.place(relx=.18,y=0)
def login_screen():
    frm=Frame(win)
...
def welcome_screen():
    ...
    def checkbal():
        ...
        lbl_page.configure(text="Check Your Balance")   
        con=sqlite3.connect(database="bank.sqlite")
        cur=con.cursor()
    ...
    def deposit():
        ...
        ifrm.configure(bg='white')
        ifrm.place(relx=.25,rely=.2,relwidth=.6,relheight=.6)
        lbl_page.configure(text="Deposit Page",fg='black')
    ...
    def withdraw():
        ifrm=Frame(frm,highlightbackground=
                   "brown",highlightthickness=3,highlightcolor='brown')
        ifrm.configure(bg='white')
        ifrm.place(relx=.25,rely=.2,relwidth=.6,relheight=.6)
        lbl_page.configure(text="Withdraw Page",fg='black')
        lbl_amt=Label(ifrm,text="Enter Amount",bg='white',font=('Arial',15,'bold'),fg='red')
        lbl_amt.place(relx=.2,rely=.2)
        e_amt=Entry(ifrm,font=('Arial',20,'bold'),bd=5)
        e_amt.place(relx=.45,rely=.2)
    ...
    def transfer():
        ...
        ifrm.configure(bg='white')
        ifrm.place(relx=.25,rely=.2,relwidth=.6,relheight=.6)
        lbl_page.configure(text="Transfer Page",fg='black')
        def transfer_db():
            t_acn=e_to.get()
            amt=float(e_amt.get())
            con=sqlite3.connect(database="bank.sqlite")
    ...
    def update():
        ...
        row=cur.fetchone()
        con.close()
        lbl_page.configure(text="Update Profile Page",fg='black')
    ...
    def txn_history():
        ...
        ifrm.configure(bg='white')
        ifrm.place(relx=.25,rely=.2,relwidth=.6,relheight=.6)
        lbl_page.configure(text="Txn history page")
        tv=Treeview(ifrm)
    ...
    lbl_wel=Label(frm,text=f"Welcome,{tup[1]}",bg='pink',font=('Arial',18,'bold'),fg='green')
    lbl_wel.place(relx=0,rely=0)
    lbl_page=Label(frm,text="Home Page",bg='pink',font=('Arial',30,'bold','underline'),fg='black')
    lbl_page.place(relx=.4,rely=0)
    btn_checkbal=Button(frm,text="Check Balance",command=checkbal,width=15,font=('Arial',15),bd=5,bg="powder blue")
    btn_checkbal.place(relx=0,rely=.1)
    btn_deposit=Button(frm,text="Deposit Amount",command=deposit,width=15,font=('Arial',15),bd=5,bg="powder blue")
    btn_deposit.place(relx=0,rely=.25)
    btn_withdraw=Button(frm,text="Withdraw Amount",command=withdraw,width=15,font=('Arial',15),bd=5,bg="powder blue")
    btn_withdraw.place(relx=0,rely=.4)
    btn_transfer=Button(frm,text="Transfer",command=transfer,width=15,font=('Arial',15),bd=5,bg="powder blue")
    btn_transfer.place(relx=0,rely=.55)
    btn_update=Button(frm,text="Update Profile",command=update,width=15,font=('Arial',15),bd=5,bg="powder blue")
    btn_update.place(relx=0,rely=.7)
    btn_txnhist=Button(frm,text="Transaction History",command= txn_history,width=15,font=('Arial',15),bd=5,bg="powder blue")
